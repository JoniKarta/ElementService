...
public interface ElementDao extends PagingAndSortingRepository<ElementEntity, String> {
	...
	public List<ElementEntity> findAllByTypeAndLocation_latBetweenAndLocation_lngBetween(
			@Param("type") String type, @Param("minLat") double minLat, @Param("maxLat") double maxLat,
